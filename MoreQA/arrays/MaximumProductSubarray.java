...
public class MaximumProductSubarray {
     ...
     * This method finds the largest product of a contiguous subarray.
     * It keeps track of the maximum and minimum product at each step because a negative number
     * can turn the minimum product into a maximum when multiplied.
     */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Maximum Product Subarray: " + findMaxProductSubarray(productNums));
    }
}
